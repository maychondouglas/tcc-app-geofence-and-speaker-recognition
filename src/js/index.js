...
/**
 * Chaves de Autenticação API Azure Maps
 */

const keysAzure = {
  authType: 'subscriptionKey',
  subscriptionKey: 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
  clientId: 'XXXXXXX-XXXXXXXX-XXXXXXX-XXXXXXX',
}
...
const keysFirebase = {
  ...
  appId: "X:XXXXXXXXXXXXXX:web:XXXXXXXXXXXXXXXX"
}
          ...
          navigator.geolocation.watchPosition(local => {
            ...
            fenceVerificationController({
              ...
              properties: {
                ...
                view: "Auto",
                authOptions: {
                  authType: keysAzure.authType,
                  subscriptionKey: keysAzure.subscriptionKey,
                  clientId: keysAzure.clientId,
